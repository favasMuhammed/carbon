...
import { kiosk_bus_dustin } from "@/lib/constants";
...
export default function KioskPage() {
  ...
  const filters = [
    { id: "all", name: "All" },
    { id: "kiosk", name: "View Kiosk" },
    { id: "bus-shelter", name: "View Bus Shelter" },
    { id: "dustbin", name: "Dustbin" },
  ];
  ...
  const [selectedColors, setSelectedColors] = useState<Record<number, string>>(
    kiosk_bus_dustin.reduce((acc, product) => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setSelectedColors((prev) => {
        ...
        kiosk_bus_dustin.forEach((product) => {
  ...
  // Filter kiosk_bus_dustin based on active filter
  const filteredkiosk_bus_dustin =
    activeFilter === "all"
      ? kiosk_bus_dustin
      : kiosk_bus_dustin.filter((product) => product.type === activeFilter);
  ...
  return (
    <>
      <div className="container mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl mt-5 mb-4">Kiosk, Bus Shelter & Dustbin</h1>
        <p className="mb-8 text-gray-700">
          Invest in durable infrastructure for your community. Our Indian-made
          Kiosks, Bus Shelters, and Dustbins, crafted from ultra-durable PP
          lumber and backed by a 5-year warranty, offer a sustainable and
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {filteredkiosk_bus_dustin.map((product) => {
              ...
              >
                <div className="relative w-full h-[370px] mb-4 overflow-hidden rounded-xl shadow-md">
                  <Image
                    ...
                    unoptimized
                    priority={product.id <= 3} // Prioritize loading for first few kiosk_bus_dustin
                  />
                </div>
                <div className="">
                        ...
                        <div
                          ...
                          className={`${getColorClass(
                            ...
                            selectedColors[product.id] === color
                              ? "ring-1 ring-offset-1 ring-gray-800"
                              : ""
                          }`}
                          onClick={(e) => {
                            e.preventDefault();
